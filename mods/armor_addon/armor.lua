...
minetest.register_tool("armor_addon:helmet_hero", {
		description = "Hero Mese Helmet",
		inventory_image = "armor_addon_inv_helmet_hero.png",
		groups = {armor_head=56, armor_heal=45, armor_use=150, physics_jump=0.10,physics_speed=0.20,armor_fire = 1,radiation =25,armor_water=1,},
	...
	minetest.register_tool("armor_addon:chestplate_hero", {
		description = "Hero Mese Chestplate",
		inventory_image = "armor_addon_inv_chestplate_hero.png",
		groups = {armor_torso=75, armor_heal=45, armor_use=150, physics_jump=0.15,physics_speed=0.20,armor_fire = 1,radiation=25,armor_water=1,},
		armor_groups = {fleshy=18.5, radiation=125},
        wear = 0,
	})
	minetest.register_tool("armor_addon:leggings_hero", {
		description = "Hero Mese Leggings",
		inventory_image = "armor_addon_inv_leggings_hero.png",
		groups = {armor_legs=75, armor_heal=45, armor_use=150, physics_jump=0.15,physics_speed=0.20,armor_fire = 1,radiation=25,armor_water=1,},
        armor_groups = {fleshy=18.5, radiation=125},
		wear = 0,
	})
	minetest.register_tool("armor_addon:boots_hero", {
		description = "Hero Mese Boots",
		inventory_image = "armor_addon_inv_boots_hero.png",
		groups = {armor_feet=12, armor_heal=12, armor_use=150, physics_jump=0.9,physics_speed=2.5,armor_fire = 2,radiation=25,armor_water=1,},
        armor_groups = {fleshy=18.5, radiation=125},
		wear = 0,
        })
        minetest.register_tool("armor_addon:shield_hero", {
		description = "Hero Mese Shield",
		inventory_image = "armor_addon_inv_shield_hero.png",
		groups = {armor_shield=56, armor_heal=45, armor_use=150, physics_jump=0.15,physics_speed=0.20,armor_fire = 1,radiation=25,armor_water=1,},
        armor_groups = {fleshy=18.5, radiation=125},
		wear = 0,
	})
...
-- Armor overrides based on updated stats chart --

local armors = {
    -- Obsidian (same as Silver)
    obsidian = {head=7, torso=8, legs=19, feet=7, shield=9, heal=5, use=700},

    -- Tin
    tin = {head=1, torso=2, legs=2, feet=1, shield=1, heal_head=2, heal_torso=2, heal_legs=2, heal_feet=1, use=500},

    -- Brick
--    brick = {head=2, torso=3, legs=3, feet=2, shield=2, heal=3, use=400},

    -- Silver
    silver = {head=3, torso=4, legs=4, feet=3, shield=3, heal=4, use=350},

    -- Rhodochrosite
--    rhodo = {head=4, torso=5, legs=5, feet=4, shield=4, heal=5, use=300},

    -- Rainbow
    rainbow = {head=5, torso=7, legs=6, feet=5, shield=6, heal=6, use=250},

    -- Waffle
    waffle = {head=4, torso=5, legs=5, feet=4, shield=5, heal=7, use=250},

    -- Chocolate
    chocolate = {head=5, torso=6, legs=6, feet=4, shield=7, heal=4, use=200},

    -- Carbonfiber
    carbonfiber = {head=8, torso=10, legs=9, feet=8, shield=8, heal=9, use=200},

    -- Skeletal
    skeletal = {head=7, torso=11, legs=10, feet=7, shield=9, heal=9, use=200},

    -- Tac Nayn
    tacnayn = {head=13, torso=15, legs=14, feet=13, shield=13, heal=11, use=150},

--    pearl = {head=3, torso=4, legs=4, feet=3, shield=3, heal=4, use=150},
--    amethyst = {head=4, torso=5, legs=5, feet=4, shield=4, heal=5, use=150},
--    sapphire = {head=5, torso=6, legs=6, feet=5, shield=5, heal=6, use=150},
--    ruby = {head=6, torso=7, legs=7, feet=6, shield=6, heal=7, use=150},

    -- Shadow
--    shadow = {head=7, torso=8, legs=8, feet=7, shield=7, heal=8, use=100},

    -- Hero Mese
    hero = {head=18, torso=18, legs=18, feet=18, shield=18, heal=12.5, use=100},
}

local function override_armor(name, stats)
    local function keep_old_fields(itemname, new_groups)
        local def = minetest.registered_items[itemname]
        if not def then return new_groups end
        local groups = def.groups or {}
        for k,v in pairs(groups) do
            if new_groups[k] == nil then
                new_groups[k] = v
            end
        end
        return new_groups
    ...
    minetest.override_item("armor_addon:helmet_"..name, {
        groups = keep_old_fields("armor_addon:helmet_"..name, {
            armor_head = stats.head,
            armor_heal = stats.heal or stats.heal_head,
            armor_use  = stats.use
        }),
        wear = 0
    })

    minetest.override_item("armor_addon:chestplate_"..name, {
        groups = keep_old_fields("armor_addon:chestplate_"..name, {
            armor_torso = stats.torso,
            armor_heal = stats.heal or stats.heal_torso,
            armor_use  = stats.use
        }),
        wear = 0
    })

    minetest.override_item("armor_addon:leggings_"..name, {
        groups = keep_old_fields("armor_addon:leggings_"..name, {
            armor_legs = stats.legs,
            armor_heal = stats.heal or stats.heal_legs,
            armor_use  = stats.use
        }),
        wear = 0
    })

    minetest.override_item("armor_addon:boots_"..name, {
        groups = keep_old_fields("armor_addon:boots_"..name, {
            armor_feet = stats.feet,
            armor_heal = stats.heal or stats.heal_feet,
            armor_use  = stats.use
        }),
        wear = 0
    })

    minetest.override_item("armor_addon:shield_"..name, {
        groups = keep_old_fields("armor_addon:shield_"..name, {
            armor_shield = stats.shield,
            armor_heal   = stats.heal or stats.heal_shield,
            armor_use    = stats.use
        }),
        wear = 0
    })
...
-- Apply overrides
for name, stats in pairs(armors) do
    override_armor(name, stats)
end
