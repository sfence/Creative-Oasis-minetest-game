local craft_ingreds = {
    ...
    cane_candy = "candycane:candy_cane",       -- fixed duplicate
    cane_edible = "christmas_decor:candycane_edible",
...
for k, v in pairs(craft_ingreds) do
    if not teru_ingots[k] then
        ...
        minetest.register_craft({
            ...
            recipe = {{v,"",v},{v,v,v},{v,v,v}},
        })
        minetest.register_craft({
            output = "armor_addon:leggings_"..k,
            recipe = {{v,v,v},{v,"",v},{v,"",v}},
        })
        minetest.register_craft({
