...
stamina.settings = {
	...
	tick = get_setting("tick", 2400),
	tick_min = get_setting("tick_min", 6),
	...
	exhaust_jump = get_setting("exhaust_jump", 2),
	exhaust_craft = get_setting("exhaust_craft", 5),
	exhaust_punch = get_setting("exhaust_punch", 10),
	exhaust_sprint = get_setting("exhaust_sprint", 10),
	exhaust_lvl = get_setting("exhaust_lvl", 360),
	heal = get_setting("heal", 4),
