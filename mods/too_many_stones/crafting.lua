...
minetest.register_craft({
	output = "too_many_stones:aegirine",
	recipe = {
		{"too_many_stones:aegirine_crystal", "too_many_stones:aegirine_crystal", "too_many_stones:aegirine_crystal"},
		{"too_many_stones:aegirine_crystal", "too_many_stones:aegirine_crystal", "too_many_stones:aegirine_crystal"},
		{"too_many_stones:aegirine_crystal", "too_many_stones:aegirine_crystal", "too_many_stones:aegirine_crystal"},
	}
})
...
minetest.register_craft({
	output = "too_many_stones:aegirine_brick 4",
	recipe = {
		{"too_many_stones:aegirine", "too_many_stones:aegirine"},
		{"too_many_stones:aegirine", "too_many_stones:aegirine"},
	}
})

minetest.register_craft({
	output = "too_many_stones:aegirine_block 9",
	recipe = {
		{"too_many_stones:aegirine", "too_many_stones:aegirine", "too_many_stones:aegirine"},
		{"too_many_stones:aegirine", "too_many_stones:aegirine", "too_many_stones:aegirine"},
		{"too_many_stones:aegirine", "too_many_stones:aegirine", "too_many_stones:aegirine"},
	}
})
...
-- Geyserite
minetest.register_craft({
	output = "too_many_stones:geyserite_brick 4",
	recipe = {
		{"too_many_stones:geyserite", "too_many_stones:geyserite"},
		{"too_many_stones:geyserite", "too_many_stones:geyserite"},
	}
})

minetest.register_craft({
	output = "too_many_stones:geyserite_block 9",
	recipe = {
		{"too_many_stones:geyserite", "too_many_stones:geyserite", "too_many_stones:geyserite"},
		{"too_many_stones:geyserite", "too_many_stones:geyserite", "too_many_stones:geyserite"},
		{"too_many_stones:geyserite", "too_many_stones:geyserite", "too_many_stones:geyserite"},
	}
})
-- Gneiss
minetest.register_craft({
	output = "too_many_stones:gneiss_brick 4",
	recipe = {
		{"too_many_stones:gneiss", "too_many_stones:gneiss"},
		{"too_many_stones:gneiss", "too_many_stones:gneiss"},
	}
})

minetest.register_craft({
	output = "too_many_stones:gneiss_block 9",
	recipe = {
		{"too_many_stones:gneiss", "too_many_stones:gneiss", "too_many_stones:gneiss"},
		{"too_many_stones:gneiss", "too_many_stones:gneiss", "too_many_stones:gneiss"},
		{"too_many_stones:gneiss", "too_many_stones:gneiss", "too_many_stones:gneiss"},
	}
})
