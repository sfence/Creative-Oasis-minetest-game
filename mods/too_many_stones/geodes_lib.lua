...
geodes_lib:register_geode({
    ...
    y_max = -10,
    scarcity = 80,
    core = "too_many_stones:aegirine",
    core_alt = "too_many_stones:aegirine_budding",
    core_alt_chance = 100,
...
geodes_lib:register_geode({
    ...
    core_alt = "too_many_stones:quartz_crystal",
    core_alt_chance = 100,
    shell = {"too_many_stones:geyserite", "too_many_stones:calcite"},
    radius_min = 2,
    radius_max = 10,
	generation_chance = 10,
})
...
geodes_lib:register_geode({
    ...
    y_max = -10,
    scarcity = 80,
    core = "too_many_stones:calcite",
    core_alt = "too_many_stones:calcite_grey",
    core_alt_chance = 100,
    shell = {"too_many_stones:geyserite", "too_many_stones:calcite_grey"},
    radius_min = 2,
    radius_max = 10,
	generation_chance = 10,
})
