...
if minetest.get_modpath("3d_armor") then
    ...
    armor:register_armor("nether_mobs:dragon_chestplate", {
        ...
        groups = {armor_torso=1, armor_heal=11, armor_use=100, armor_fire=1},
    ...
    armor:register_armor("nether_mobs:dragon_leggings", {
        ...
        groups = {armor_legs=1, armor_heal=11, armor_use=100, armor_fire=1},
    ...
    armor:register_armor("nether_mobs:dragon_boots", {
        ...
        groups = {armor_feet=1, armor_heal=10, armor_use=100, armor_fire=1, physics_jump=0.5, physics_speed = 1},
    ...
    armor:register_armor("nether_mobs:dragon_shield", {
        ...
        groups = {armor_shield=1, armor_heal=10, armor_use=100, armor_fire=2},
