...
mobs.human = {
	...
	names = {
		"Bob", "Opons", "Bill", "fappy1", "James", "Ian", "Lenny",
		"Dylan", "Ethan", "Sam", "Aubrey", "ana", "I_am", "Joe", "Lucy"
	},
	...
	items = {
		...
		{mcl and "mcl_core:diamond 1" or "default:diamond 1",
				mcl and "mcl_core:gold_ingot 10" or "default:gold_ingot 10", 40},
		{mcl and "mcl_farming:wheat_item 10" or "farming:wheat 20",
		...
		{mcl and "mcl_copper:raw_copper 1" or "default:mese_crystal_fragment 1",
				mcl and "mcl_core:gold_ingot 5" or "default:gold_ingot 1", 90}
	}
}
