...
if armor.materials.crystal then
	...
	armor:register_armor(":3d_armor:helmet_crystal", {
		...
		groups = {armor_head=1, armor_heal=9, armor_use=100, armor_fire=1},
		armor_groups = {fleshy=7.5},
	...
	armor:register_armor(":3d_armor:chestplate_crystal", {
		...
		groups = {armor_torso=1, armor_heal=9, armor_use=100, armor_fire=1},
	...
	armor:register_armor(":3d_armor:leggings_crystal", {
		...
		groups = {armor_legs=1, armor_heal=9, armor_use=100, armor_fire=1},
		armor_groups = {fleshy=8},
		damage_groups = {cracky=2, snappy=1, level=3},
	})
	--- Crystal Boots
	...
	armor:register_armor(":3d_armor:boots_crystal", {
		...
		groups = {armor_feet=1, armor_heal=9, armor_use=100, physics_speed=1,
