...
minetest.register_craft({
    ...
    recipe = {
        {"", "elepower_dynamics:steel_ingot", ""}, {
            "elepower_dynamics:steel_ingot", "elepower_dynamics:steel_ingot",
            "elepower_dynamics:steel_ingot"
        }
    }
})
...
minetest.register_craft({
    ...
    recipe = {
        {"", "elepower_dynamics:steel_ingot", "elepower_dynamics:steel_ingot"},
        {
            "elepower_dynamics:steel_ingot", "elepower_dynamics:steel_plate",
            "elepower_dynamics:steel_ingot"
        },
        {"elepower_dynamics:steel_ingot", "elepower_dynamics:steel_ingot", ""}
    }
...
minetest.register_craft({
    ...
    recipe = {
        {"", "elepower_dynamics:battery", "elepower_dynamics:steel_ingot"},
...
minetest.register_craft({
    ...
    recipe = {
        {"", epi.diamond_block, "elepower_dynamics:steel_plate"}, {
            "elepower_dynamics:lead_plate", "elepower_dynamics:xycrone_lump",
    ...
    recipe = {
        {
            ...
            "elepower_dynamics:micro_circuit",
            "elepower_dynamics:wound_copper_coil"
        }, {
            "elepower_tools:repair_core", "elepower_machines:machine_block",
            "elepower_tools:repair_core"
        }, {
