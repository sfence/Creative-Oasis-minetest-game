-- -- -- -- -- -- -- --
-- Normal Earthball with Protection
-- -- -- -- -- -- -- --
...
minetest.register_entity("even_mosword:earthball", {
    visual = "mesh",
    visual_size = {x=5, y=5},
    mesh = "mosword_ball.x",
        ...
        for dx = 0,1 do
            for dy = 0,1 do
                for dz = 0,1 do
                    ...
                    if n == "air" then
                        safe_set_node(p, self.owner, "default:dirt")
                    end
                end
            end
        end
...
-- Earth Sword Tool
minetest.register_tool("even_mosword:earth_sword", {
    description = "Earth Sword",
    inventory_image = "mosword_earth_sword.png",
    light_source = 2,
