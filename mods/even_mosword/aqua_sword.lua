-- -- -- -- -- -- -- --
-- Normal Aquaball with Protection
-- -- -- -- -- -- -- --
...
minetest.register_entity("even_mosword:aquaball", {
    visual = "mesh",
    visual_size = {x=5, y=5},
    mesh = "mosword_ball.x",
    ...
    -- store owner for protection checks
    owner = nil,
        ...
        for dx = 0,1 do
            for dy = 0,1 do
                for dz = 0,1 do
                    ...
                    if n == "air" then
                        safe_set_node(p, self.owner, "default:water_source")
                    end
                end
            end
        end
...
-- Aqua Sword Tool
minetest.register_tool("even_mosword:aqua_sword", {
    description = "Aqua Sword",
    inventory_image = "mosword_aqua_sword.png",
    light_source = 2,
    ...
    on_use = function(itemstack, placer, pointed_thing)
        ...
        local obj = minetest.add_entity(
            ...
            "even_mosword:aquaball"
        )
        if obj then
            obj:get_luaentity().owner = placer  -- store player for protection check
