-- -- -- -- -- -- -- --
-- Normal Frozenball with Protection
-- -- -- -- -- -- -- --
...
minetest.register_entity("even_mosword:frozenball", {
    visual = "mesh",
    visual_size = {x=5, y=5},
    mesh = "mosword_ball.x",
        ...
        for dx = 0,1 do
            for dy = 0,1 do
                for dz = 0,1 do
                    ...
                    if n == "air" then
                        safe_set_node(p, self.owner, "default:ice")
                    end
                end
            end
        end
...
-- Frozen Sword Tool
minetest.register_tool("even_mosword:frozen_sword", {
    description = "Frozen Sword",
    inventory_image = "mosword_frozen_sword.png",
    light_source = 2,
...
minetest.register_craft({
    output = "even_mosword:frozen_sword",
    recipe = {
        {'bucket:bucket_water', 'default:ice', ''},
        {'bucket:bucket_water', 'default:ice', ''},
        {'', 'default:steel_ingot', ''},
    }
})
