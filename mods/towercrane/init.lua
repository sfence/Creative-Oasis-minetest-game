...
if towercrane.recipe then
	minetest.register_craft({
		...
		recipe = {
                {xcompat.materials.steel_ingot, xcompat.materials.gold_ingot, xcompat.materials.steel_ingot},
		    	{xcompat.materials.gold_ingot, "default:diamond", "basic_materials:chainlink_brass"},
 		    	{xcompat.materials.steel_ingot, xcompat.materials.dye_yellow, "basic_materials:chainlink_brass"}
            }
