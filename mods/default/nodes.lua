...
minetest.register_on_mods_loaded(function()
    local leaves = {
        ...
        "default:acacia_bush_leaves",
        "default:pine_bush_needles",
        -- Technic (adjust names if needed)
        "technic:rubber_tree_leaves",
        "technic:stone_tree_leaves",
        -- Ethereal leaves
        "ethereal:bamboo_leaves",
        "ethereal:cherry_leaves",
        "ethereal:orange_leaves",
        "ethereal:jungletree_leaves",
        "ethereal:palm_leaves",
        "ethereal:pine_leaves",
        "ethereal:rainforest_leaves",
        "ethereal:redwood_leaves",
        "ethereal:willow_leaves",
    }

    for _, name in ipairs(leaves) do
        if minetest.registered_nodes[name] then
            minetest.override_item(name, {
                walkable = false,           -- fall slowly through leaves
                climbable = true,           -- can climb like ladders
                groups = table.copy(minetest.registered_nodes[name].groups),
                liquid_viscosity = 3,       -- slows movement like water
                fall_damage_add_percent = -50,  -- reduces fall damage
            })
        end
    end
end)
