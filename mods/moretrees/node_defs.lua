...
-- Wait until all mods are loaded so we can override Moretrees nodes
minetest.register_on_mods_loaded(function()

    local moretrees_leaves = {
        ...
        "moretrees:jungletree_leaves",
        "moretrees:willow_leaves",
        "moretrees:rubber_tree_leaves",
        "moretrees:palm_leaves",
        "moretrees:pine_leaves",
        "moretrees:acacia_leaves",
        "moretrees:poplar_leaves",
    }

    for _, name in ipairs(moretrees_leaves) do
        if minetest.registered_nodes[name] then
            minetest.override_item(name, {
                walkable = false,               -- you fall slowly through leaves
                climbable = true,               -- climb like ladders
                liquid_viscosity = 3,           -- slows movement (water=1, lava=7)
